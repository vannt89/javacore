public class Utils {
    ...
    static void subMenu() {
        System.out.println("Có 3 cách giải bài tập này");
        System.out.println("Nhấn 1: Dùng vòng lặp for");
        System.out.println("Nhấn 2: Dùng vòng lặp while");
        System.out.println("Nhấn 3: Dùng vòng lặp do-while");
        System.out.println("Nhấn 0 để thoát bài này");
